     ...
     {stepData?.policyType === "OD only Policy" &&( <div>
      ...
      {stepData.paCover === "Yes" && (<>
        ...
        <div>
          ...
          <input name="paCoverAmount" type="text" value={stepData.paCoverAmount || 0} onChange={handleChange}
      ...
      <div>
        ...
        <input type="text" name="odAmount" value={stepData.odAmount || 0} onChange={handleChange}
      ...
      <div>
        ...
        <input type="text" name="tpAmount" value={stepData.tpAmount || 0} onChange={handleChange}
      ...
      <div>
        ...
        <input type="text" name="gstAmount" value={stepData.gstAmount || 0} onChange={handleChange}
      ...
      <div>
        ...
        <input type="text" name="breakingCharge" value={stepData.breakingCharge || 0} onChange={handleChange}
          className={`w-full border px-4 py-2  rounded`} />

      </div>
      <div>
        <label>Waiver Amount</label>
        <input type="text" name="waiverAmount" value={stepData.waiverAmount || 0} onChange={handleChange}
          className="w-full border px-4 py-2 border-[#e6e6e6] rounded" />
      </div>
      <div>
